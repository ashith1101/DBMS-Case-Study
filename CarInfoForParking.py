...
myc=mydb.cursor()
myc.execute("create table if not exists ParkingInfo(CarNumber varchar(25), CarColor varchar(25), CarType varchar(25), CardType varchar(25), CardNumber varchar(25), ParkingTime varchar(25),ParkingDate varchar(25),SpotNum varchar(25) unique);")
